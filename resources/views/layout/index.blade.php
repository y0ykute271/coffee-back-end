...
<!DOCTYPE html>
<head>
<title>Quản trị bán cofee</title>
...
<!-- font-awesome icons -->
<link rel="stylesheet" href="admin_assets/css/font.css" type="text/css"/>
<link href="admin_assets/css/font-awesome.css" rel="stylesheet"> 
<link rel="stylesheet" href="admin_assets/css/morris.css" type="text/css"/>
<!-- calendar -->
<link rel="stylesheet" href="admin_assets/css/monthly.css">
<!-- //calendar -->
<!-- //font-awesome icons -->
<script src="admin_assets/js/jquery2.0.3.min.js"></script>
<script src="admin_assets/js/raphael-min.js"></script>
<script src="admin_assets/js/morris.js"></script>
{{-- dinh nghia cai vung --}}
@yield('head')
</head>
<body>
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src="admin_assets/images/2.png">
                <span class="username">
                   fdhg
                </span>
                <b class="caret"></b>
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						...
						<li><a href="user">Danh sách users</a></li>                       
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="#">Thêm loại</a></li>
						<li><a href="#">Tất cả loại</a></li>                       
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
...
<section id="main-content">
	<section class="wrapper">
        <!-- trong day yield la cai bien dinh cai vung  ben kia thi goi section('content') endsetion -->
		<!-- <h3>Chào các bạn đến với admin</h3> -->
		@yield('content')		
	</section>	
 <!-- footer -->
		  <div class="footer">
...
<script src="admin_assets/js/jquery.dcjqaccordion.2.7.js"></script>
...
<!-- calendar -->
	<script type="text/javascript" src="admin_assets/js/monthly.js"></script>
